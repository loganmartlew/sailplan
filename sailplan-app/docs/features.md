...
| **sailPolar**    | Sail polar data: CRUD, CSV import, polar/scatter charts, and **IDW interpolation** with confidence. | `util/interpolation` (`estimateSailSpeed`), `PolarPlotChart`, `ScatterChart`, `SailPolarImportDialog` · [README](../features/sailPolar/README.md) |
