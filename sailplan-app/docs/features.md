...
| **capture**      | NMEA capture sessions: the schema mirror for sessions, samples, connection events, sail stamps, sailed legs, spans and plotter setup. Schema only so far — nothing writes to these tables yet. | `model/capture`                                              |
