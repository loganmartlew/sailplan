...
| **Sail-attribution span** | An interval within a sailed leg assigned to one sail — or to none, which review calls **no sail**. Either proposed as a review draft or confirmed by the sailor. The app may infer draft spans from sail stamps and surrounding conditions, but only confirmed spans can contribute to polar promotion. Spoken of as a **block** in review, where a leg reads as a row of them. |
